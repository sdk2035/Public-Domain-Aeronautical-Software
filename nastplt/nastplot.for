...
!!!     *         READONLY)
      OPEN(UNIT=PLTFIL,FILE=filnam,STATUS='OLD',ACTION='READ')

      OPEN(UNIT=20,FILE='NASTPLOT.SUM',STATUS='REPLACE',ACTION='WRITE')
...
300       TYPE *, 'ERROR OPENING FILE', FILNAM
      WRITE(*,*) ' DO YOU WANT A DIFFERENT FILE ? (YES OR NO): '
      READ(*,'(A)') REQFIL
