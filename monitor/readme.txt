...
MONITOR- MONTE CARLO INVESTIGATION OF TRAJECTORY             /monitor/readme.txt
   OPERATIONS AND REQUIREMENTS

The files for this program are in the directory monitor 
  readme.txt      this file of general description
  original.src    the original copy of the source code (from COSMIC)
  gsc12705.txt    the original program description from COSMIC
