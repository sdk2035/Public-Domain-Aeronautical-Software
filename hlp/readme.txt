...
The files for this program are in the directory hlp 
  readme.txt      general description
  hlp.f90         the source code
  drh.cmn         common block used several times in source code
...
those of us with black and white printers, this 
