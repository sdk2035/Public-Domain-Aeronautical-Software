...
The files for this program are in the directory hyper 
...
from the web page https://www.pdas.com/hyperrefs.html. 
...
In addition to the files mentioned above, there is a directory called /igor
