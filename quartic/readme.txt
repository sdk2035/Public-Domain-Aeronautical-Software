...
The files for this program are in the directory quartic 
...
from the web page https://www.pdas.com/quarticrefs.html. 
...
me mail and I will try to clear it up. There is some confusion with the 
return codes, but I will try to sort that out soon.
