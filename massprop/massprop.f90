...
! 02Dec18  1.6   RLC   Corrected type of variables ki,kii,kiii
...
IMPLICIT NONE
  ...
  CHARACTER(LEN=*),PARAMETER:: VERSION = "1.6 (2 December 2018)"
...
!----------------------------------------------------------------------------
  ...
  WRITE(OUT,*) 'Mass properties of a rigid structure'
  WRITE(OUT,*) 'Version '//VERSION
  WRITE(OUT,'(2A/2A)') 'This file was compiled by ', compiler_version(),           &
                    ' using the options ',         compiler_options()
  WRITE(DBG,*) 'Mass properties of a rigid structure'
  WRITE(DBG,*) 'Version '//VERSION
  WRITE(DBG,'(2A/2A)') 'This file was compiled by ', compiler_version(),           &
                    ' using the options ',         compiler_options()
  ...
  WRITE(OUT,*) "Reading from "//Trim(fileName)
...
!  WRITE(OUT,'(7F12.3)' ) TW,IXXO,IYYO,IZZO,XBAR,YBAR,ZBAR
  ...
  WRITE(OUT,FMTD) " xbar,ybar,zbar  ", xbar,ybar,zbar
